        ...
        <>
            <Icons >
                    ...
                    <Link data-aos="fade-left" data-aos-delay="320"
                        to = {{pathname:"https://github.com/aman12207"}} 
                        target={"_blank"} 
                    ...
                    <Link data-aos="fade-right" data-aos-delay="325"
                        to = {{pathname: "https://www.linkedin.com/in/aman-gupta12207/"}} 
                        target={"_blank"} 
                        rel="noopener noreferrer">
                    ...
                    <Link data-aos="fade-left" data-aos-delay="330"
                        to = {{pathname:"mailto:amangupta12207@gmail.com"}} 
                        target={"_blank"} 
                        rel="noopener noreferrer"> 
                    ...
                    <Link data-aos="fade-right" data-aos-delay="335"
                        to = {{pathname:"https://twitter.com/AmanGup05036215"}} 
                        target={"_blank"} 
                        rel="noopener noreferrer">
